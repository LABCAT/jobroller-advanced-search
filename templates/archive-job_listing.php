...
?>
    ...
    <form action="/jobs/" method="get" id="searchform">
		<div class="search-wrap">
            <div>
                <input type="text" title="" name="s" class="text" placeholder="Job Keyword" value="" style="width: calc(100% - 36px) !important; height: 30px;">
                <button type="submit" title="" class="submit">
